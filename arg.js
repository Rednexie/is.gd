...
let threads = process.argv[2]
let delay = process.argv[3];
...
if(isNaN(threads) || threads === 0){
  console.log("threads should be a number greater than 0.")
  console.log("Usage: node arg.js <threads> <delay>")
  return process.exit(1)
}
if(isNaN(delay)){
  console.log("delay should be a number")
  console.log("Usage: node arg.js <threads> <delay>")
  return process.exit(1)
}
